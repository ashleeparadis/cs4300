...
SECRET_KEY = 'django-insecure-6qv7qvie$!e$3)l!cx1=n+5@^qz!@f0=*6b)%124b$f6ibp*w0'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework.authentication.SessionAuthentication',  # Default for Django sessions
        'rest_framework.authentication.BasicAuthentication',  # Basic Authentication
    ],
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # Restrict access to authenticated users only
    ],
}
